...
| Chain | < AGC-024 (Persistence category) . next AGC-026 > |
...
SIEM rules should treat an unpaired EID 4732 with HIGHER priority than a paired 4720+4732, because it suggests an attacker is leveraging an already-compromised identity rather than creating an obvious new account.
