...
**Navigation:** [< AGC-090](../../15-threat-hunting/AGC-090-hunt-lolbin-parent-child/README.md) | [AGC-092 >](../../15-threat-hunting/AGC-092-hunt-logon-time-patterns/README.md)
...
|-------------|------|--------|-------------|
| T1071 | Application Layer Protocol | Command and Control | **Hunted** -- No active beaconing patterns detected from management workstation. All connections are local services. Full conn.log analysis from Security Onion would provide comprehensive coverage but was unavailable due to lab constraints (no Guest Additions, Wazuh indexer offline). |
